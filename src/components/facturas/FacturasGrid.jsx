              ...
              <div key={grupo.id} className="client-vault-card">
                ...
                <div className="client-vault-header">
                  ...
                  <div className="vault-client-right">
                    ...
                    {/* Botón para eliminar toda la carpeta de comprobantes del cliente */}
                    <button
                      type="button"
                      className="btn-delete-vault-folder"
                      title={`Eliminar carpeta completa de ${grupo.nombre_completo} y purgar archivos de Storage`}
                      onClick={() => onEliminarCarpeta && onEliminarCarpeta(grupo)}
                    >
